...
const metrics = [
  { key: "speed", title: "Speed vs Time", unit: "km/h", stepped: false },
  { key: "throttle", title: "Throttle vs Time", unit: "%", stepped: false },
  { key: "brake", title: "Brake vs Time", unit: "%", stepped: true },
  { key: "n_gear", title: "Gear vs Time", unit: "gear", stepped: true },
  { key: "rpm", title: "RPM vs Time", unit: "rpm", stepped: false }
] as const;
